...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  const [registrations, setRegistrations] = useState<Registration[]>([
    {
      ...
      rating: '1850',
      status: 'pending',
      registeredAt: new Date('2025-10-10').toISOString(),
    },
    {
      id: '2',
      tournamentId: '1',
      tournamentTitle: 'Dinajpur District Championship 2025',
      playerName: 'Farzana Ahmed',
      email: 'farzana@example.com',
      phone: '+880 1812-345678',
      category: 'Women',
      rating: '1720',
      status: 'pending',
      registeredAt: new Date('2025-10-11').toISOString(),
    },
    {
      id: '3',
      tournamentId: '2',
      tournamentTitle: 'Friday Night Blitz Tournament',
      playerName: 'Shahidul Haque',
      email: 'shahid@example.com',
      phone: '+880 1912-345678',
      category: 'Open',
      rating: '1950',
      status: 'approved',
      registeredAt: new Date('2025-10-12').toISOString(),
    },
    {
      id: '4',
      tournamentId: '1',
      tournamentTitle: 'Dinajpur District Championship 2025',
      playerName: 'Nasir Ahmed',
      email: 'nasir@example.com',
      phone: '+880 1512-345678',
      category: 'Senior',
      rating: '1680',
      status: 'pending',
      registeredAt: new Date('2025-10-13').toISOString(),
    },
    {
      id: '5',
      tournamentId: '2',
      tournamentTitle: 'Friday Night Blitz Tournament',
      playerName: 'Ayesha Khan',
      email: 'ayesha@example.com',
      phone: '+880 1612-345678',
      category: 'Junior',
      rating: '1520',
      status: 'rejected',
      registeredAt: new Date('2025-10-14').toISOString(),
    },
  ]);
  ...
  const updateRegistration = (id: string, registration: Partial<Registration>) => {
    setRegistrations(registrations.map(r => r.id === id ? { ...r, ...registration } : r));
  };
