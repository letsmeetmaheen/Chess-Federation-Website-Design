          ...
          <div className="space-y-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="glass-royal rounded-xl p-6 shadow-lg hover:border-purple-500 dark:hover:border-purple-400 gel-transition cursor-pointer royal-glow">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="elastic-bounce">
                  <Button className="bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 hover:from-purple-700 hover:via-blue-700 hover:to-purple-700 text-white px-8 py-6 shadow-xl royal-glow">
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="elastic-bounce">
                  <Button variant="outline" className="px-8 py-6 border-2 glass-purple border-purple-600 text-purple-600 dark:text-purple-400 hover:border-purple-500">
