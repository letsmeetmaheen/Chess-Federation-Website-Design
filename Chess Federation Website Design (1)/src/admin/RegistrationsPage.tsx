      ...
      <Tabs defaultValue="all" className="space-y-4">
        ...
        <TabsContent value="pending">
          <RegistrationsTable
            ...
            getStatusColor={getStatusColor}
            getCategoryColor={getCategoryColor}
            totalCount={registrations.filter(r => r.status === 'pending').length}
          />
        </TabsContent>
        ...
        <TabsContent value="approved">
          <RegistrationsTable
            ...
            getStatusColor={getStatusColor}
            getCategoryColor={getCategoryColor}
            totalCount={registrations.filter(r => r.status === 'approved').length}
          />
        </TabsContent>
      </Tabs>
...
function RegistrationsTable({
  ...
  const isFiltered = totalCount > 0 && registrations.length === 0;
